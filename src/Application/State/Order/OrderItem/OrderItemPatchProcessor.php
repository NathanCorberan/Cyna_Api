...
class OrderItemPatchProcessor implements ProcessorInterface
{
    ...
    {
        if (!$data instanceof OrderItemPatchInputDto) {
            throw new \InvalidArgumentException('Expected OrderItemPatchInputDto DTO.');
        }
